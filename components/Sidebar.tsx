...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div className="w-64 bg-slate-950 h-screen text-slate-300 flex flex-col fixed left-0 top-0 shadow-2xl z-50 border-r border-slate-800">
      <div className="p-8">
      ...
      <div className="p-6 mt-auto border-t border-slate-900 bg-slate-950/50 backdrop-blur-md">
        <div className="flex items-center gap-3 mb-6 px-1">
          ...
          <div className="overflow-hidden">
            ...
            <p className="text-[8px] text-slate-500 font-bold uppercase tracking-widest truncate">System Identity Verified</p>
          </div>
        </div>
        <button 
          onClick={onLogout}
