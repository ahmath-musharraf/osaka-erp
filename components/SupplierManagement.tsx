               ...
               <div className="bg-blue-600 text-white p-8 rounded-[3rem] shadow-2xl animate-in zoom-in-95 duration-300">
                  ...
                  <div className="space-y-4">
                     ...
                     <button 
                        ...
                        className={`w-full py-4 rounded-2xl border-2 border-dashed flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all ${billImage ? 'bg-emerald-500 border-emerald-400' : 'bg-white/5 border-white/20 hover:border-white'}`}
                     >
                        {billImage ? <CheckCircle size={16} /> : <Camera size={16} />}
                        {billImage ? 'Invoice Uploaded' : 'Upload Invoice Photo'}
                     </button>
          ...
          >
            ...
            <div className="w-full overflow-hidden">
               ...
               <div className="mt-2 pt-2 border-t border-slate-50">
                  <span className={`text-[10px] font-black ${s.balance > 0 ? 'text-red-600' : 'text-emerald-600'}`}>
           ...
           <div className="bg-white w-full max-w-xl rounded-[3rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-500">
              <div className="p-10 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       <h3 className="text-xl font-black text-slate-900">Supplier Registry</h3>
                       <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Establish Partner Credentials</p>
                    </div>
                 </div>
              ...
              <form onSubmit={handleRegisterSupplier} className="p-10 space-y-6">
                 ...
                 <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                       ...
                       <input 
                         ...
                         className="w-full p-4 bg-slate-50 border-none rounded-2xl text-sm font-black outline-none focus:ring-4 focus:ring-blue-500/10"
                         placeholder="+94"
                         value={newSupplier.whatsappNumber}
                         onChange={(e) => setNewSupplier({...newSupplier, whatsappNumber: e.target.value})}
                       />
                    </div>
                 </div>
                 <div className="space-y-2">
                 ...
                 <div className="space-y-2">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Internal Remarks (Optional)</label>
                    <textarea 
                      ...
                      placeholder="Enter supplier history, lead times, credit terms..."
